...
export class A extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AState, opts?: pulumi.CustomResourceOptions): A {
        return new A(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'infoblox:record/a:A';
    ...
    constructor(name: string, argsOrState?: AArgs | AState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AState | undefined;
            ...
            const args = argsOrState as AArgs | undefined;
